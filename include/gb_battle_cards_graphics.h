#ifndef GB_BATTLE_CARDS_GRAPHICS_H
#define GB_BATTLE_CARDS_GRAPHICS_H
...
#include "gb_cards.h"
#include "gb_battle_cards_graphics_constants.h"
...
namespace gb::battle
{
    ...
    struct cards_graphics
    {
        ...
        void show_info(bn::string<13> title, bn::string<32> body);
